...
public abstract  class CourseBaseActivity  extends BaseFragmentActivity
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putSerializable(Router.EXTRA_COURSE_UPGRADE_DATA, courseUpgradeData);
    ...
    protected void restore(Bundle savedInstanceState) {
        ...
        courseUpgradeData = (CourseUpgradeResponse) savedInstanceState.getSerializable(Router.EXTRA_COURSE_UPGRADE_DATA);
